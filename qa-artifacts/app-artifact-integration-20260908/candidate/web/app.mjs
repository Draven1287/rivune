import { initializeArtifactReview } from './artifact-review.mjs';
...
const archiveInspector = host?.inspectLegacyImport
  ...
  : null;
export const artifactReview = initializeArtifactReview({host});
...
function render() {
  artifactReview.update(!shutdownFrozen && snapshot?.conversations.some(c => c.id === selectedConversationID) ? selectedConversationID : null);
