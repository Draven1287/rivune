  ...
  return (
    <aside aria-label="Workspace navigation" className="flex h-full min-h-0 flex-col bg-zinc-950/70 text-zinc-200">
      <div className="px-4 pb-4 pt-5">
        <button type="button" onClick={onNewConversation} disabled={!onNewConversation} className="flex min-h-10 w-full items-center gap-2.5 rounded-lg border border-white/10 bg-white/[0.06] px-3 py-2 text-left text-sm font-medium text-zinc-100 transition-colors hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-sky-300 disabled:cursor-not-allowed disabled:opacity-50 motion-reduce:transition-none">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-3 pb-5">
        <nav aria-label="Projects and conversations" className="pb-5 pt-2">
          <p className="px-2 text-xs font-medium text-zinc-400">Conversations</p>
          <details open className="mt-3">
            <summary className="min-h-9 cursor-pointer rounded-md px-2 py-2 text-sm font-medium text-zinc-200 hover:bg-white/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-sky-300">Personal workspace</summary>
        ...
        <details className="workspace-tools border-t border-white/10 py-4">
          <summary className="cursor-pointer text-xs font-semibold text-zinc-300">Developer tools</summary>
          <div className="pt-3">
