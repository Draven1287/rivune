...
export function createHostAdapter(host) {
  ...
  return Object.freeze({
    ...
    ...(typeof host.getRecoveryScopeID === "function" ? { getRecoveryScopeID: () => host.getRecoveryScopeID() } : {}),
    ...
    ...(typeof host.onOpenReview === "function" ? { onOpenReview: (handler) => host.onOpenReview(handler) } : {}),
  });
}
