...
async function runFixture() {
  ...
  try {
    for (const id of ['qa:team-first', 'qa:team-second']) await b.configureProvider({id,kind:'codex',executablePath:"/private/tmp/rivune-team-fixed-qa-wydd7kmb/codex",model:null,timeoutMs:600000},true);
