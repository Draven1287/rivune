...
final class CouncilFoundationTests: XCTestCase {
    ...
    func testIndependentCouncilFailureRecoveryAndCancellation() async throws {
        let participants = [CouncilParticipant(identity: .init(id: "a", providerID: "openai", adapterID: "codex", modelID: nil, displayName: "ChatGPT"), route: .codexCLI, options: .accountDefault),
                            CouncilParticipant(identity: .init(id: "b", providerID: "anthropic", adapterID: "claude", modelID: nil, displayName: "Claude"), route: .claudeCodeCLI, options: .accountDefault)]
...
final class CouncilGroundingBoundaryTests: XCTestCase {
    private var participants: [CouncilParticipant] {
        [.init(identity: .init(id: "a", providerID: "openai", adapterID: "codex", modelID: nil, displayName: "A"), route: .codexCLI, options: .accountDefault),
         .init(identity: .init(id: "b", providerID: "anthropic", adapterID: "claude", modelID: nil, displayName: "B"), route: .claudeCodeCLI, options: .accountDefault)]
    }
...
private actor CouncilBudgetTransport: AITextRunning {
    var calls: [String] = []
    let original: String
    let repair: String
