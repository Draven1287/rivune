...
r=Path.cwd();o=r/'qa-artifacts/startup-contention-correction-20260910';native=r/'qa-artifacts/cross-platform-shell-20260907/candidate4-runtime-r2/src-tauri'
...
for label,args in [('startup',['--bin','rivune','startup']),('dock',['--bin','rivune','dock_reopen'])]:
