...
export async function validateExecution(options, actualOS = process.platform) {
  ...
  return {
    ...
    inputs: { tauriConfigPath, cargoManifestPath, rustBuildScriptPath, cargoLockPath, cargoConfigPaths, frontendDist: rendererRoot, productIdentity, metadataCommand, externalLocalDependencies, macToolchain, expectedOutput },
