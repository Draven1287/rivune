...
def render_tokens(data, fixture=False):
    ...
    tokens = {
        ...
        "HERO_NOTE": "The Tauri desktop app is in development for macOS, Windows, and Linux.",
        "MAC_REQUIREMENT": "No verified Tauri download exists for macOS, Windows, or Linux.",
        "DOWNLOAD_TITLE": "Get Rivune.",
        "DOWNLOAD_DESCRIPTION": "Choose your platform to check availability.",
        "DOWNLOAD_CONTROL": control,
        "RELEASE_META": "",
        "RELEASE_NOTE": "Tauri desktop downloads are not available yet.",
        ...
        "PLATFORM_MAC_BODY": "The unified Tauri desktop app is in development. No verified macOS download exists yet.",
        "INSTALL_SECTION": "",
    }
    if ready:
...
const platformPanel=document.querySelector('[data-platform-panel]'),macReady=platformPanel?.dataset.releaseReady==='true';const platforms={mac:['macOS',macReady?'Mac download available':'macOS download not yet available',macReady?'A validated Mac DMG is available below. Check its version and system requirements before downloading.':'The unified Tauri desktop app is in development. No verified macOS download exists yet.'],windows:['Windows','Windows download not yet available','The unified Tauri desktop app is in development. No verified Windows download exists yet.'],linux:['Linux','Linux download not yet available','The unified Tauri desktop app is in development. No verified Linux download exists yet.']};
