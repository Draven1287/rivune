...
final class RivuneTerminationDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationShouldHandleReopen(_ sender: NSApplication, hasVisibleWindows flag: Bool) -> Bool {
        ...
        let window = flag ? nil : RivuneWindowRecovery.recoverableWorkspaceWindow(in: sender.windows)
        lifecycle.record(.reopenRequested, detail: flag ? "visible" : (window == nil ? "create" : "restore"))
        if let window {
