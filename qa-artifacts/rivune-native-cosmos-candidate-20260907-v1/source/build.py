...
document.querySelectorAll('[data-demo-example]').forEach(b=>b.addEventListener('click',()=>{example=b.dataset.demoExample;stage='perspectives';renderDemo();}));document.querySelectorAll('[data-demo-stage]').forEach(b=>b.addEventListener('click',()=>{stage=b.dataset.demoStage;renderDemo();}));document.querySelector('[data-demo-reset]')?.addEventListener('click',()=>{example='project';stage='perspectives';renderDemo();});
