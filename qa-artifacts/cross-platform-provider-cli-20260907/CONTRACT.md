...
6. Native Windows `.cmd`, `.bat`, and `.ps1` wrappers are detected but fail closed. Supporting them would require a reviewed shell-specific quoting contract; this prototype accepts only direct executable binaries and never constructs a shell command string.
