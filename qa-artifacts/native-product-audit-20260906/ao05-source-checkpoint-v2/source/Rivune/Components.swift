...
private struct ComposerPermissionMenu: View {
    ...
    var body: some View {
        RivuneActionMenu(title: "Tools and permissions", actions: [
            ...
            .init(title: "Remove all selected files", systemImage: "xmark.circle", isEnabled: !store.draftAttachments.isEmpty) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    if advanced {
                        ...
                        ForEach(members.filter { $0.memberID != orchestrator }, id: \.memberID) { member in
                            HStack {
                                Button {
                                ...
                                if let index = fallbacks.firstIndex(of: member.memberID) {
                                    ...
                                    Button("Move earlier", systemImage: "arrow.up") { fallbacks.swapAt(index, index - 1) }
