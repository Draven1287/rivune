...
if(selected.length!==1||selected[0]!=='saved-result'){
 ...
 window.addEventListener('pagehide',()=>{window.removeEventListener('keydown',key);if(previous)Object.defineProperty(navigator,'clipboard',previous);else Reflect.deleteProperty(navigator,'clipboard');},{once:true});
